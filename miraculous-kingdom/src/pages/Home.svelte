...
>
    <div
        class="flex flex-col top-0 mb-8 rounded-xl bg-slate-800 p-8 text-7xl font-bold text-blue-600"
    >
        <img class="h-96" src={src} alt="Miraculous Kingdom Logo"/>
    </div>
    <div class="p-16 bg-black rounded-xl">
