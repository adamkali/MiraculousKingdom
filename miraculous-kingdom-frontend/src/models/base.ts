...
export namespace APIURLTypes {
    export interface ApicharacterApiApi {
        getCharacterForGame: string;
        getCharacters: string;
    }
    export interface ApiclassApiApi {
        getClass: string;
        getClasses: string;
    }
    export interface ApigameApiApi {
        addCharacter: string;
        getGame: string;
        getGames: string;
        startGame: string;
    }
    export interface ApiseasonApiApi {
        getSeason: string;
        getSeasons: string;
        roll: string;
    }
